...
export default function PortalReferenceLayout() {
  ...
  return (
    <div dir={direction} className="min-h-screen bg-[#f6f7f3] px-4 py-4 lg:px-6 lg:py-5">
      <div dir="ltr" className="mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-[1600px] overflow-hidden rounded-[26px] border border-[#dde5e1] bg-white shadow-[0_18px_48px_-40px_rgba(15,23,42,0.18)] lg:grid-cols-[0.94fr_0.86fr]">
        <section dir={direction} className="order-1 flex flex-col bg-white px-6 py-5 lg:px-8 lg:py-6">
          <header dir="ltr" className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex h-12 w-[300px] items-center justify-between rounded-[20px] border border-[#dde5e1] bg-white px-4 shadow-[0_12px_24px_-22px_rgba(15,23,42,0.14)]">
              ...
              <div className={direction === 'rtl' ? 'text-right' : 'text-left'}>
                <div className="text-[12px] font-extrabold leading-none text-[#1f3435]">
                  {user?.fullName || t('common.systemUser')}
                </div>
            ...
            {canUseRoleSwitch && availableRoles.length > 1 ? (
              <div dir={direction} className="inline-flex h-12 w-[330px] items-center gap-1 rounded-[20px] border border-[#dde5e1] bg-white p-1 shadow-[0_12px_24px_-22px_rgba(15,23,42,0.14)]">
        ...
        <section dir={direction} className="order-2 relative overflow-hidden bg-[#2f6666] text-white">
          ...
          <div className="relative flex h-full flex-col items-center justify-center px-7 py-8">
            ...
            <div className="mt-10 w-full max-w-[360px] rounded-[28px] border border-white/8 bg-white/[0.14] px-7 py-7 text-center shadow-[0_20px_36px_-32px_rgba(0,0,0,0.2)] backdrop-blur-[2px]">
              <div className="text-[12px] font-semibold text-white/88">{t('common.platform')}</div>
              <div className="mt-3 text-[26px] font-extrabold leading-tight">{t('common.agency')}</div>
            </div>
          </div>
        </section>
      </div>
...
function MaterialsIcon() {
  return (
    <svg viewBox="0 0 96 96" fill="none" className="h-[58px] w-[58px]">
      <path d="M20 74V37.5L48 22l28 15.5V74h-8V43H28v31h-8Z" fill="currentColor" />
      <path d="M34 49h28" stroke="#4f7678" strokeLinecap="round" strokeWidth="4.8" />
      <path d="M33 59.5h10v10H33zm12.5 0H56v10H45.5zm12.5 0H69v10H58zm-25 12.5h10v10H33zm12.5 0H56v10H45.5z" fill="#4f7678" />
    </svg>
  );
}
...
function ServicesIcon() {
  return (
    <svg viewBox="0 0 96 96" fill="none" className="h-[58px] w-[58px]">
      <path d="m29 31 36 36" stroke="currentColor" strokeLinecap="round" strokeWidth="8" />
      <path d="m56 24 16 16-10 10-16-16 10-10Z" fill="currentColor" />
      <path d="m26 68 14-14 15 15-14 14a8 8 0 0 1-11.3 0l-3.7-3.7a8 8 0 0 1 0-11.3Z" fill="currentColor" />
...
function UserIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
      ...
      <path d="M5.5 18.2c1.8-3 4.1-4.5 6.5-4.5s4.7 1.5 6.5 4.5" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
    </svg>
  );
}
...
function BellIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
      <path d="M8 10a4 4 0 1 1 8 0v2.6c0 .8.2 1.5.7 2.1l.8 1H6.5l.8-1c.5-.6.7-1.3.7-2.1V10Z" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.8" />
